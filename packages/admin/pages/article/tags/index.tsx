    ...
    <AdminLayout>
      <Row gutter={16} className={style.wrapper}>
        <Col xs={24} sm={24} md={9}>
          <Card title={isCreateMode ? '添加標籤' : '管理標籤'} bordered={true}>
            <Form.Item>
              <Input
                value={label}
                placeholder={'輸入標籤名稱'}
            ...
            <Form.Item>
              <Input
                value={value}
                placeholder={'輸入標籤值（請輸入英文，作為路由使用）'}
                onChange={(e) => {
