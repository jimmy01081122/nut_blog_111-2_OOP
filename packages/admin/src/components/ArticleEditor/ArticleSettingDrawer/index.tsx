...
const initialArticleAttrs = {
  summary: null, // 摘要
  password: null, // 密碼
  isCommentable: true, // 評論
  isRecommended: true, // 推薦到首頁
  category: null, // 分類
  tags: [], // 標籤
  cover: null, // 封面
};
...
export const ArticleSettingDrawer: React.FC<IProps> = ({ article, visible, onClose, onChange }) => {
  ...
  return (
    <Drawer width={480} placement="right" title={'文章設置'} closable={true} onClose={onClose} visible={visible}>
      <FormItem
        label="文章摘要"
        content={
          <Input.TextArea
